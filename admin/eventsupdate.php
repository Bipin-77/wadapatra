...
// }
$id = $_GET['id'];
$listRecord = $user->getRecordByIdEvents($id);
        ...
        if (
            ...
            if (move_uploaded_file(
                ...
                $uploadDirectory . $filename
                    ...
                    $cerated = $user->updateEvents($_POST,$id, $filename);
                    if ($cerated) {
                ...
                <div class="form-container">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" class="description" name="description" value="<?php echo $listRecord['description'] ?>"
                                required ></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="image" name="image" value="<?php echo $listRecord['image'] ?>" accept="image/*"  required>
                        </div>

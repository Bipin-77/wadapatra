...
if (isset($_POST['title'])) {
    ...
    if (
        ...
        if (
            ...
            $cerated = $user->updatePolls($_POST, $id,$filename);
            if ($cerated) {
                ...
                <div class="form-container">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="title" name="title" value="<?php echo $listRecord['title'] ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="image" name="image" accept="image/*" value="<?php echo $listRecord['image'] ?>">
                        </div>

    ...
    if (
        ...
        if (move_uploaded_file(
            ...
            $uploadDirectory . $filename
                ...
                $cerated = $user->updateOfficials($_POST,$id, $filename);
                if ($cerated) {
        ...
        <main class="main">
            ...
            <div class="content">
                <div class="form-container">
                    ...
                    <h2> Update Officials details</h2>
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <input type="text" id="area" name="post" value="<?php echo $listRecord['post'] ?>" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" id="elected_date" name="elected_date" value="<?php echo $listRecord['elected_date'] ?>" required>
                        </div>

                        <div>
                            <label for="endDate">End Date:</label>
                            <input type="date" id="end_date" name="end_date" value="<?php echo $listRecord['end_date'] ?>"required>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="details" rows="4" value="<?php echo $listRecord['details'] ?>" required></textarea>
                        </div>
                        <div >

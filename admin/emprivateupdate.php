...
$user = new Emergency();
$id= $_GET["id"];
$listRecord= $user->getRecordByIdPrivate($id);
...
if (isset($_POST['service'])) {
    ...
    $cerated = $user->editPrivate($_POST,$id);
    if ($cerated) {
                ...
                <div class="form-container">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="service" name="service" value="<?php echo $listRecord['service'] ?>"
                                required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="address" name="address" value="<?php echo $listRecord['address'] ?>"
                                required>
                        </div>
